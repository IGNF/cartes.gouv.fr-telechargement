    ...
    <HeaderMenu
      ...
      items={[
        ...
        },
        {
          ...
          linkProps: {
            href: "https://cartes.gouv.fr/aide/fr/guides-utilisateur/rechercher-une-donnee/",
            target: "_blank",
          },
        },
        {
          ...
          linkProps: {
            href: "https://cartes.gouv.fr/aide/fr/niveau-de-service",
            target: "_blank",
          },
        },
        {
    ...
    <HeaderMenu
      ...
      items={[
        ...
        },
        {
          ...
          linkProps: {
            href: "https://cartes.gouv.fr/publier-une-donnee",
            target: "_self",
          },
        },
        // {
    ...
    <HeaderMenu
      ...
      items={[
        ...
        },
        {
          ...
          linkProps: {
            href: "https://cartes.gouv.fr/mon-compte",
            target: "_self",
          },
        },
      ]}
